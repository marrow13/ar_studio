...
{
	$to = 'marrow@ukr.net';
	$subject = 'Заказ с сайта Газоблоки';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["name7"],ENT_COMPAT,'UTF-8') . '</td></tr>';

	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Телефон:</b></td><td>' . htmlentities($_REQUEST["phone7"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Сообщение:</b></td><td>' . htmlentities($_REQUEST["message7"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>utm_source:</b></td><td>' . htmlentities($_REQUEST["utm_source"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>utm_medium:</b></td><td>' . htmlentities($_REQUEST["utm_medium"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>utm_campaign:</b></td><td>' . htmlentities($_REQUEST["utm_campaign"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>utm_term:</b></td><td>' . htmlentities($_REQUEST["utm_term"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>utm_content:</b></td><td>' . htmlentities($_REQUEST["utm_content"],ENT_COMPAT,'UTF-8') . '</td></tr>';
