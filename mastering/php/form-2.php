...
{
	$to = 'director@arefyevstudio.com';
	$subject = 'Сообщение с контактной формы (/мастеринг)';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["name1"],ENT_COMPAT,'UTF-8') . '</td></tr>';

	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Телефон:</b></td><td>' . htmlentities($_REQUEST["phone1"],ENT_COMPAT,'UTF-8') . '</td></tr>';
